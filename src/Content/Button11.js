                    ...
                    >
                        ...
                        >
                            <ul className="flex-col justify-center items-center">
                                <li className="flex py-2 hover:text-[#00857C] text-black text-md items-center font-medium border-b-2 justify-between" onClick={VeevabuildUploadTask}>
                                  {props.Uploadtask} <ContentCopyRoundedIcon className='mx-2'/>  
                                </li>
                                <li className="flex py-2 hover:text-[#00857C] text-black text-md items-center font-medium justify-between " onClick={VeevabuildReuploadTask}>
                                  {props.ReUploadtask} <ContentCopyRoundedIcon className='mx-2'/>  
                                </li>
                            </ul>
                        </div>}
                        <button className='flex justify-evenly m-auto text-center text-white bg-[#1b9a92] border-0 p-2 focus:outline-none hover:bg-[#00857C] rounded text-xs w-[11.2rem]'
                        >
                            {props.name}
                        </button>
                    </span>
