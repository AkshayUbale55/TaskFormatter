                    ...
                    >
                        ...
                        >
                            <ul className="flex-col justify-center items-center">
                                <li className="flex py-2 hover:text-[#00857C] justify-between text-black text-md items-center font-medium border-b-2" onClick={copyOutlookIB}>
                                    {props.IB} <ContentCopyRoundedIcon className='mx-2'/>  
                                </li>
                                <li className="flex py-2 hover:text-[#00857C] justify-between text-black text-md items-center font-medium " onClick={copyOutlookCR}>
